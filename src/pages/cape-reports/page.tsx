...
const CapeReports = () => {
  const [activeTab, setActiveTab] = useState<'capes' | 'reports' | 'instructions'>('capes');
  const [searchTerm, setSearchTerm] = useState('');

  const capesWithReports: CapeWithReport[] = [
    {
      id: 1,
      typeCape: "Centres de long séjour",
      denomination: "Orphelinat Mère Brandis",
      nombreEnfants: 45,
    ...
    },
    {
      id: 2,
      typeCape: "Centres de long séjour", 
      denomination: "Centre des aveugles Père Paul Rival \"ALLO YON\"",
      nombreEnfants: 28,
      effectifPersonnel: 8,
      statut: "Soumis"
    },
    {
      id: 3,
      typeCape: "Centres de long séjour",
      denomination: "Orphelinat Saint Jean Paul II",
      nombreEnfants: 32,
      effectifPersonnel: 10,
      statut: "Validé"
    },
    {
      id: 4,
      typeCape: "Centres de long séjour",
      denomination: "Centre d'accueil des orphelins et enfants vulnérables OHANA",
      nombreEnfants: 38,
      effectifPersonnel: 11,
      statut: "En retard"
    }
  ];
  ...
  const activityReports: ActivityReport[] = [
    {
      id: 1,
      description: "Rapport d'activité trimestriel Q1 2024",
      statut: "Soumis",
      transmis: "15/04/2024",
      fichier: "rapport_q1_2024.pdf"
    },
    {
      id: 2,
      description: "Rapport d'activité mensuel Mars 2024",
      statut: "Validé",
      transmis: "05/04/2024", 
    ...
    {
      id: 3,
      description: "Rapport d'activité trimestriel Q4 2023",
      statut: "En attente",
      transmis: "-",
      fichier: "-"
    }
  ...
  const instructions: Instruction[] = [
    {
      id: 1,
      instruction: "Les rapports d'activité doivent être soumis dans les 15 jours suivant la fin de la période concernée"
    },
    {
      id: 2,
      instruction: "Utiliser obligatoirement le modèle de rapport fourni par l'administration"
    },
    {
      id: 3,
      instruction: "Joindre les pièces justificatives (factures, reçus, photos) en annexe"
    },
    {
      id: 4,
      instruction: "Le rapport doit être signé par le directeur de l'établissement"
    }
  ];
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold text-gray-900">Rapports d'activité CAPE</h1>
      </div>
      ...
      <div className="mb-6">
        <div className="border-b border-gray-200">
          <nav className="-mb-px flex space-x-8">
            ...
            >
              Liste des capes ayant déposé des rapports d'activité
            </button>
            <button
        ...
        {activeTab === 'capes' && (
          <>
            <div className="px-6 py-4 border-b border-gray-200 bg-blue-900 text-white rounded-t-lg">
              <h2 className="text-lg font-semibold">Liste des capes ayant déposé des rapports d'activité</h2>
              <p className="text-blue-100 text-sm mt-1">0 élément(s)</p>
            </div>
            <div className="p-6">
