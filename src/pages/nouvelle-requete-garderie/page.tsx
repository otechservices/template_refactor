...
export default function NouvelleRequeteGarderie() {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <select 
                  ...
                  onChange={(e) => handleInputChange('typeGarderie', e.target.value)}
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Adresse de la garderie"
                  required
                />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="contact@garderie.ci"
                  required
                />
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => handleInputChange('capaciteAccueil', e.target.value)}
                  placeholder="Nombre d'enfants maximum"
                  min="1"
                  required
                />
              </div>
              <div>
                ...
                >
                  ...
                  <option value="0-6">0 à 6 ans</option>
              ...
              <div className="md:col-span-2">
                ...
                <textarea
                  ...
                  placeholder="Décrivez les services offerts par la garderie..."
                  rows={4}
            ...
            <div className="bg-gray-50 p-6 rounded-lg space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">{formData.typeGarderie}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-900">{formData.capaciteAccueil} enfants ({formData.trancheAge})</p>
                </div>
                <div>
                  <span className="font-medium text-gray-700">Personnel:</span>
                  <p className="text-gray-900">{formData.effectifPersonnel} personnes</p>
                </div>
                <div>
                  <span className="font-medium text-gray-700">Horaires:</span>
                  <p className="text-gray-900">{formData.horairesOuverture}</p>
                </div>
              </div>
  ...
  return (
    <div className="p-6">
        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div className="flex items-center">
              ...
              <span className="ml-1 text-gray-500 font-medium">Nouvelle requête Garderie</span>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <Card>
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">Nouvelle demande d'agrément Garderie</h1>
