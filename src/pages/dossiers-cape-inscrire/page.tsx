...
const mockDossiers = [
  {
    id: 1,
    reference: 'CAPE-INS-001',
    denomination: 'Centre Éducatif Harmonie',
  ...
  {
    id: 2,
    reference: 'CAPE-INS-002',
    denomination: 'École Maternelle Avenir',
    responsable: 'Kouame Michel',
    commune: 'Plateau',
  ...
  {
    id: 3,
    reference: 'CAPE-INS-003',
    denomination: 'Centre Les Petites Étoiles',
    responsable: 'Mariam Touré',
    commune: 'Adjamé',
  ...
  {
    id: 4,
    reference: 'CAPE-INS-004',
    denomination: 'École Maternelle Sagesse',
    responsable: 'Ibrahim Koné',
    commune: 'Marcory',
    dateValidation: '2024-01-12',
    capacite: 50,
    typeStructure: 'Confessionnelle',
    statut: 'Validé',
    session: ''
  }
];
...
const sessions = [
  { id: 1, nom: 'Session Mars 2024', date: '2024-03-15', places: 20 },
  { id: 2, nom: 'Session Avril 2024', date: '2024-04-20', places: 15 },
  { id: 3, nom: 'Session Mai 2024', date: '2024-05-18', places: 25 }
];

export default function DossiersCapesInscrire() {
  ...
  const confirmerInscription = () => {
    ...
    alert(`${selectedDossiers.length} dossier(s) inscrit(s) en session`);
    setSelectedDossiers([]);
  ...
  return (
    <div className="p-6">
        ...
        <ol className="inline-flex items-center space-x-1 md:space-x-3">
          ...
          <li>
            <div className="flex items-center">
              ...
              <span className="ml-1 text-gray-500 font-medium">Dossiers CAPE à inscrire</span>
            </div>
          </li>
        </ol>
      </nav>
      ...
      <div className="space-y-6">
        ...
        <Card title="Sessions d'agrément disponibles">
        ...
        {/* Liste des dossiers */}
        <Card title="Dossiers CAPE validés à inscrire en session">
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md">
            ...
            <div className="mb-4">
              <p className="text-sm text-gray-600 mb-3">
                Sélectionnez une session pour inscrire {selectedDossiers.length} dossier(s) :
              </p>
